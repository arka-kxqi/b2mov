...
function CreateProposal() {
  ...
  const { smartAccount, sendUserOp, getFeeQuotes } = useETHProvider();
          ...
          const abi = ABI.abi;
            ...
            const signer = provider.getSigner();
              ...
              notification.success({
                ...
                description: (
                  <div>
                    Transaction Hash: <a href={`https://testnet-explorer.bsquared.network/tx/${hash}`} target="_blank" rel="noopener noreferrer">{hash}</a>
                  </div>
                )
              });
  ...
  <div id="wrapper">
    ...
    >
      ...
      >
        ...
        <div className="sidebar-brand-text mx-3">BTC Club</div>
      </a>
      {/* Divider */}
...
onChange={(e) => setDestination(e.target.value)}
                        placeholder="Enter the BTC destination address: 0x....."
                      />{" "}
                      <br />
                      Amount (in BTC):{" "}
                      <input
